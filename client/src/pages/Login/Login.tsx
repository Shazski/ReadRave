        ...
        <Form className="flex flex-col gap-y-6">
          ...
          <div>
            <label className="input input-bordered flex items-center gap-2">
              ...
              <Field value="test@gmail.com" type="text" name="email" className="grow" placeholder="Email" />
            </label>
          ...
          <div>
            <label className="input input-bordered flex items-center gap-2">
              ...
              <Field value="Test@1234" type="password" name="password" placeholder="Password" className="grow" />
            </label>
